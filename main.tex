...
\begin{document}
	...
	\begin{frontmatter}
		...
		\author[1]{Fatima Ouaar\corref{cor1}}
		\author[2]{Safia Ouaar}
		\ead{f.ouaar@univ-biskra.dz}
		
		\affiliation[1]{organization={Department of Mathematics, University of Biskra}, country={Algeria}}
		\affiliation[2]{organization={Department of Economics, University of Biskra}, country={Algeria}}
		...
		\begin{keyword}
			Portfolio optimisation \sep Higher-order moments \sep Particle swarm optimisation \sep Utility feedback \sep Shrinkage estimation \sep Bootstrap inference \sep G11 \sep C61 \sep C63 \sep C15
		\end{keyword}
