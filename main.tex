...
\begin{document}
	...
	\begin{frontmatter}
		...
		\author[1]{Fatima Ouaar\corref{cor1}} \ead{f.ouaar@univ-biskra.dz}
		...
		\begin{keyword}
			Portfolio optimisation \sep Higher-order moments \sep Particle swarm optimisation  \sep C61 \sep C63 \sep C15
		\end{keyword}
