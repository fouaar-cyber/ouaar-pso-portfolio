...
\begin{document}
	...
	All data used in this study are publicly available. S\&P 500 and BIST-100 stock returns were obtained from Yahoo Finance via the \texttt{yfinance} Python library (\url{https://pypi.org/project/yfinance/}). 
	
	Replication code is available at \url{https://github.com/fouaar-cyber/ouaar-pso-portfolio} and will be archived on Zenodo upon acceptance with a persistent DOI.
	
	\section*{Declaration of AI Assistance}
	
	A language model assistant (Kimi) was used for language editing only. The authors take full responsibility for all mathematical derivations, statistical validation, scientific conclusions, and the entire research process.
	...
	Experiments ran on standard hardware. Average runtime: approximately 5 minutes per market. Code: Python 3.11, NumPy, scikit-learn, yfinance. Full replication materials available at \url{https://github.com/fouaar-cyber/ouaar-pso-portfolio}.
	...
	\begin{thebibliography}{99}
		...
		\bibitem[Golmakani and Fazel(2022)]{golmakani2022}
		...
		\bibitem[Harvey and Siddique(2020)]{harvey2020}
		...
		\bibitem[Jonsson and Rockinger(2023)]{jonsson2023}
		...
		\bibitem[Maringer and Parpas(2009)]{maringer2009}
