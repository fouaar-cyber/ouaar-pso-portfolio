...
% Geometry for JPRM
\usepackage[textwidth=12.5cm, textheight=19cm, centering]{geometry}
...
% Authors
\author{Fatima Ouaar$^{a}$ and Safia Ouaar$^{b,*}$\\
\small $^{a}$Department of Mathematics, University of Biskra, Algeria\\
\small $^{b}$Department of Economics, University of Biskra, Algeria\\
...
\begin{abstract}
This study proposes a utility-feedback particle swarm optimiser with adaptive inertia weight adjustment. We establish boundedness of the inertia sequence and demonstrate convergence properties empirically. The method combines shrinkage estimation with factor-structured higher-moment approximations, reducing parameter complexity from $O(d^4)$ to $O(dK)$. Block-bootstrap inference validates performance metrics. Applications to portfolio selection demonstrate efficacy in higher-moment optimization.
\end{abstract}
...
Meta-heuristics---including particle swarm optimisation (PSO) \citep{eberhart1995pso} ---offer alternatives to convex relaxations \citep{golmakani2022constrained,zhang2020portfolio}. Yet two gaps persist: (i) inertia weight tuning remains largely ad-hoc \citep{poli2007pso}, and (ii) higher-moment estimation error is rarely addressed \citep{jonsson2023moment}.
...
\item[{[1]}] R. Eberhart and J. Kennedy, A new optimizer using particle swarm theory, in: \textit{Proc. IEEE Int. Symp. Micro Machine and Human Science}, IEEE, 1995, 39--43.

\item[{[2]}] H. R. Golmakani and M. Fazel, Constrained PSO for skewness-kurtosis portfolio models: An updated benchmark, \textit{Expert Systems with Applications} 203 (2022) 117129.

\item[{[3]}] C. R. Harvey and A. Siddique, Conditional skewness in asset pricing tests: Twenty-year retrospective, \textit{Journal of Finance} 76(4) (2020) 1821--1852.

\item[{[4]}] M. Jonsson and M. Rockinger, Moment component analysis in portfolio selection: A review, \textit{Journal of Banking and Finance} 148 (2023) 106118.

\item[{[5]}] O. Ledoit and M. Wolf, A well-conditioned estimator for large-dimensional covariance matrices, \textit{Journal of Multivariate Analysis} 88(2) (2004) 365--411.

\item[{[6]}] O. Ledoit and M. Wolf, Robust performance hypothesis testing with the Sharpe ratio, \textit{Journal of Empirical Finance} 15(5) (2008) 850--859.

\item[{[7]}] D. Maringer and P. Parpas, Global optimization of higher order moments in portfolio selection, \textit{Journal of Global Optimization} 43(2--3) (2009) 219--230.

\item[{[8]}] R. Poli, J. Kennedy and T. Blackwell, Particle swarm optimization: An overview, \textit{Swarm Intelligence} 1(1) (2007) 33--57.

\item[{[9]}] R. C. Scott and P. A. Horvath, On the direction of preference for moments of higher order than the variance, \textit{Journal of Finance} 35(4) (1980) 915--919.

\item[{[10]}] Y. Zhang, D. W. Gong and X. Z. Gao, Portfolio optimization based on multi-objective particle swarm optimization open architecture, \textit{Expert Systems with Applications} 151 (2020) 113371.
